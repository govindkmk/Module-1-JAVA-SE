...
public class FileCRUD {
    public static void main(String[] args) throws Exception{
        ...
        InputStream stdfile = new FileInputStream("CRUDStudents.txt");

        System.out.println("\n<<<<<<<<<<Welcome to Student Data>>>>>>>>>>>\n");

        OutputStream os = new FileOutputStream("CRUDStudents.txt");
        os.write("ID    Name    Department      Age     Email\n".getBytes());

        FileOutputStream fos = new FileOutputStream("CRUDStudents.txt");
        ...
        do{
            ...
            switch (num){
                case 1:
                    ...
                    if (Pattern.matches("^(.+)(@)(.+)$", email)) {
                        std.setEmail(email);
                        students.add(std);
                        os.write((std.getId()+" "+std.getName()+" "+std.getDepartment()+" "+std.getAge()+" "+std.getEmail()+"\n").getBytes());
                ...
                case 5:
                    try {
                        Scanner scanner = new Scanner(new File("CRUDStudents.txt"));
            ...
            System.out.println("\nDo you wanna continue then type y or therwise n... :");
            ch = sc.next().charAt(0);
        }while(ch == 'y');
        os.close();
    }
